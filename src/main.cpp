...
void autonomous( void ) {
  ...
  if(autoOptions == 0){
    ...
    setRoller(100,12000);
    setDrive(90, 22);  //knock stack down
    wait(100);
    waitDriveNew(9);
    setRoller(0,0);

    setRoller(100,8000);
    setDrive(90, 19);  //move to pick more cubes
    wait(100);
    waitDriveNew(9);
    wait(800);
    ...
    setDrive(90, 0, 92.5); //turn to zones
    setRoller(100, 300);
    wait(100);
    waitDriveNew(7,7);
    ...
    setDrive(100,19.8);  //move to zone
    wait(500);
    setRoller(-100, 400);
    waitDriveNew(12);  
  ...
  if(autoOptions == 2){ 
    ...
    setSwivel(100, 1200);   //deploy rollers and tray
    wait(600);
    setRoller(100,3000);
    setSwivel(100,-100);
    setArm(80, 270);
    ...
    setDrive(80, 28.5);     //pick up 3 cubes
    wait(100);
    waitDriveNew(5,5);
    ...
    setDrive(100,-49);     //back up to wall
    wait(400);
    setRoller(0, 0);
    waitDriveNew(10);

    setDrive(100, 18);    //move forward
    wait(100);
    waitDriveNew(10);
    
    setDrive(100,0,-119);   //turn to zones
    setRoller(100,2200);
    wait(950);
    waitDriveNew(8,6);
  ...
  if(autoOptions == 4){
    ...
    setRoller(100,8000);
    setDrive(90, 20);  //move to pick more cubes
    wait(100);
    waitDriveNew(9);
    wait(800);
    ...
    setDrive(90, 0, -92); //turn to zones
    setRoller(100, 300);
    wait(100);
    waitDriveNew(7,7);
  ...
  if(autoOptions == 6){
    ...
    setDrive(80, 28.5);       //pick up cubes
    wait(100);
    waitDriveNew(5,5);
    ...
    setDrive(100, 15);  //move forward away from wall
    wait(100);
    waitDriveNew(10);
    
    setDrive(100,0,122.5);   //turn to zones
    setRoller(100,2200);
    wait(950);
    waitDriveNew(10,7);
